local ui =  game:GetService("CoreGui"):FindFirstChild("redui") if ui then ui:Destroy() end
...
function create:Win(text)
    ...
    ClickFrame.BackgroundColor3 = Color3.fromRGB(28,28,28)
    ...
    NameReal.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
    ...
    NameReal.TextColor3 = Color3.fromRGB(225,225,225)
    ...
    MainSceen2.BackgroundColor3 = Color3.fromRGB(25,25,25)
    ...
    ScolTapBarFrame.BackgroundColor3 = Color3.fromRGB(34,34,34)
    ...
    ScrollingFrame_Menubar.BackgroundColor3 = Color3.fromRGB(34,34,34)
    ...
    function create:Notifile(titel,text,delays)
      ...
      imagenoti.Image = "https://www.roblox.com/asset-thumbnail/image?assetId=7578496318&width=0&height=0&format=png"
        ...
        txdlid.Text = titel
        txdlid.TextColor3 = Color3.fromRGB(15,15,15)
...
--Time.AnchorPoint = Vector2.new(0.5, 0.5)
    ...
    function top:Taps(text)
        ...
        ScrollingFrame_Pagefrist.BackgroundColor3 = Color3.fromRGB(255,255,255) -- 240, 255, 255
    ...
    --        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(240, 255, 255)
            ...
            TextLabel_Toggle.TextColor3 = Color3.fromRGB(15,15,15)
            ...
            TextButton_Toggle2.TextColor3 = Color3.fromRGB(15,15,15)
